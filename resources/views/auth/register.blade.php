            ...
            <div class="card text-center">
                <div class="card-body">
                    <div class="card-title">
                        <b>Inscríbete y comienza a aprender.</b>
                    </div>
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group">
                            <div>
                                <input id="password-confirm" placeholder="confirme contraseña" type="password" class="form-control" name="password_confirmation" required autocomplete="new-password">
                            </div>
                        </div>
